class VCOM
{
	...
	class Init
	{
		...
		{
			file = "\vcomai\Vcom\VcomInitClient.sqf";
			postInit = 1;
		};
		class CBA_Settings // Only executed if CBA is present
		{
			file = "\vcomai\Vcom\Functions\VCM_CBASettings.sqf";
		};
	};
	
	class FSM
	{
		file = "\vcomai\Vcom\FSMS";
	...
	class Artillery
	{
		file = "\vcomai\Vcom\Functions\VCM_Functions\artillery";
	...
	class Actions
	{
		file = "\vcomai\Vcom\Functions\VCM_Functions\actions";
	...
	class Driving
	{
		file = "\vcomai\Vcom\Functions\VCM_Functions\driving";
	...
	class Explosives
	{
		file = "\vcomai\Vcom\Functions\VCM_Functions\explosives";
	...
	class Garrison
	{
		file = "\vcomai\Vcom\Functions\VCM_Functions\garrison";
	...
	class Movement
	{
		file = "\vcomai\Vcom\Functions\VCM_Functions\movement";
	...
	{
		file = "\vcomai\Vcom\Functions\VCM_Functions\situation";
	...
	class Scanning
	{
		file = "\vcomai\Vcom\Functions\VCM_Functions\scanning";
	...
	class Suppression
	{
		file = "\vcomai\Vcom\Functions\VCM_Functions\suppression";
...
class RYD
{
	...
	class FFE_Functions
	{
		file = "\vcomai\Vcom\Functions\FFE_Functions";
		class AngTowards {};
		class ArtyMission {};
		class ArtyPrep {};
		class AutoConfig {};
	...
	class FFE_Shellview
	{
		file = "\vcomai\Vcom\Functions\FFE_Shellview";
		class Shellview {};
	};
};